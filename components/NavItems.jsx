    ...
    <div>
        {!session && <Link href='/'>
          {providers && Object.values(providers).map((provider , index) => (
            <button className='bg-gray-100 px-3 text-blue-700 rounded-xl py-1 border-[3px] hover:border-pink-300 hover:text-blue-900' key={index} onClick={() => signIn(provider.id)}>
              Sign In
            </button>
          ))}
        </Link>}
