  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <form className="space-y-4">
        ...
        <button
          className="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400"
